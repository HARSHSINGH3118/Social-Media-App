...
const PostCard = (param)=>{
    ...
    const handleToggleComments = async ()=>{
        ...
        if (!showComments) {
            try {
                const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get("/api/posts/".concat(id, "/comments"));
    ...
    const handleAddComment = async (e)=>{
        ...
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post("/api/posts/".concat(id, "/comments"), {
                content: commentText
            });
...
_s(PostCard, "vwu2ImBZoGJ+8B+SHmpuPl30lFY=");
_c = PostCard;
...
//# sourceMappingURL=src_f1dae512._.js.map