...
function NotificationsPage() {
    ...
    // 1) Fetch initial notifications from your API
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "NotificationsPage.useEffect": ()=>{
            ...
            fetch("/api/notifications", {
                ...
                "NotificationsPage.useEffect": (res)=>res.json()
            }["NotificationsPage.useEffect"]).then({
                "NotificationsPage.useEffect": (data)=>setNotifications(data.notifications || [])
            }["NotificationsPage.useEffect"]).catch(console.error);
        }
    }["NotificationsPage.useEffect"], [
        user
    ]);
    // 2) Subscribe to real-time pushes
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "NotificationsPage.useEffect": ()=>{
            if (!socket) return;
            const handler = {
                "NotificationsPage.useEffect.handler": (notif)=>{
                    setNotifications({
                        "NotificationsPage.useEffect.handler": (prev)=>[
                                notif,
                                ...prev
                            ]
                    }["NotificationsPage.useEffect.handler"]);
                }
            }["NotificationsPage.useEffect.handler"];
            socket.on("notification", handler);
            return ({
                "NotificationsPage.useEffect": ()=>void socket.off("notification", handler)
            })["NotificationsPage.useEffect"];
        }
    }["NotificationsPage.useEffect"], [
        socket
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                ...
                notifications.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                    ...
                    children: notifications.map((notif, i)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                ...
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                        ...
                                                        children: notif.message || notif.type || "sent you a notification"
                                                    }, void 0, false, {
                                                        fileName: "[project]/src/app/notifications/page.jsx",
                                                        lineNumber: 59,
                                                        columnNumber: 23
...
_s(NotificationsPage, "qw4FdRrheGoGhDzjx4jEgRVDMuY=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$contexts$2f$SocketContext$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSocket"],
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$contexts$2f$AuthContext$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"]
    ];
...
//# sourceMappingURL=src_c16d1a0e._.js.map