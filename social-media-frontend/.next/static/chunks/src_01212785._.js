...
"[project]/src/components/NotificationList.jsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function NotificationList() {
    ...
    const realtimeBuffer = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])([]);
    ...
    const mergeUnique = (a, b)=>{
        ...
        [
            ...a,
            ...b
        ].forEach((n)=>(n === null || n === void 0 ? void 0 : n.id) && map.set(n.id, n));
    ...
    const fetchNotifications = async ()=>{
        ...
        try {
            ...
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get("/notifications");
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "NotificationList.useEffect": ()=>{
            if (!socket) return;
            const handler = {
                "NotificationList.useEffect.handler": (notif)=>{
                    console.log("🟢 RECEIVED notification via socket:", notif);
                    setNotes({
                        "NotificationList.useEffect.handler": (prev)=>{
                            const updated = mergeUnique([
                                notif
                            ], prev);
                            return updated.slice(0, 30); // ✅ Limit to latest 30
                        }
                    }["NotificationList.useEffect.handler"]);
                }
            }["NotificationList.useEffect.handler"];
            socket.on("notification", handler);
            return ({
                "NotificationList.useEffect": ()=>socket.off("notification", handler)
            })["NotificationList.useEffect"];
        }
    }["NotificationList.useEffect"], [
        socket
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "NotificationList.useEffect": ()=>{
            const onFocus = {
                "NotificationList.useEffect.onFocus": ()=>fetchNotifications()
            }["NotificationList.useEffect.onFocus"];
            window.addEventListener("focus", onFocus);
            return ({
                "NotificationList.useEffect": ()=>window.removeEventListener("focus", onFocus)
            })["NotificationList.useEffect"];
        }
    }["NotificationList.useEffect"], []);
    const handleMarkAllRead = async ()=>{
        setMarking(true);
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].put("/notifications/read");
    ...
    const formatText = (n)=>{
        switch(n.type){
            case "message":
                return 'sent you: "'.concat(n.message, '"'); // ✅ SHOW MESSAGE CONTENT
            case "like":
    ...
    if (loading) return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
        ...
        fileName: "[project]/src/components/NotificationList.jsx",
        lineNumber: 98,
        columnNumber: 23
    }, this);
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("ul", {
                className: "space-y-3",
                children: notes.slice(0, 10).map((n, idx)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
                        className: "flex items-start gap-3 p-3 rounded-md border ".concat(n.is_read ? "bg-gray-50" : "bg-blue-50 border-blue-300"),
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$app$2d$dir$2f$link$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                        href: n.post_id ? "/posts/".concat(n.post_id) : "/profile/".concat(n.sender_id),
                                        className: "text-sm",
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                className: "font-semibold",
                                                children: n.sender_name
                                            }, void 0, false, {
                                                fileName: "[project]/src/components/NotificationList.jsx",
                                                lineNumber: 134,
                                                columnNumber: 17
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: new Date(n.created_at || Date.now()).toLocaleString()
                                    }, void 0, false, {
                                        fileName: "[project]/src/components/NotificationList.jsx",
                                        lineNumber: 137,
                                        columnNumber: 15
...
_s(NotificationList, "iIWqsRjNjZxxjLL7lOOdwBHO41Q=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$contexts$2f$SocketContext$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSocket"],
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$contexts$2f$AuthContext$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"]
    ];
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$NotificationList$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/NotificationList.jsx [app-client] (ecmascript)");
"use client";
;
;
;
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$AppLayout$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$NotificationList$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {}, void 0, false, {
                    fileName: "[project]/src/app/notifications/page.jsx",
                    lineNumber: 12,
                    columnNumber: 9
                }, this)
...
//# sourceMappingURL=src_01212785._.js.map