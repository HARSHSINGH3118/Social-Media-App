...
const api = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].create({
    baseURL: ("TURBOPACK compile-time value", "https://social-media-app-326k.onrender.com/api") || "http://localhost:5000/api",
...
const AuthProvider = (param)=>{
    ...
    const fetchProfile = async (tok)=>{
        try {
            ...
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get("/users/profile", {
                headers: {
...
_s(SocketProvider, "c0GeYONYPmJcrsO8fGxrlhAsUo8=", false, function() {
    return [
...
//# sourceMappingURL=src_ad1de238._.js.map