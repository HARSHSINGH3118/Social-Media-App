...
function MessagesListPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "MessagesListPage.useEffect": ()=>{
            const fetchUsers = {
                "MessagesListPage.useEffect.fetchUsers": async ()=>{
            ...
            }["MessagesListPage.useEffect.fetchUsers"];
            const fetchLastMessages = {
                "MessagesListPage.useEffect.fetchLastMessages": async ()=>{
                    const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get("/api/messages");
                    const map = {};
                    res.data.forEach({
                        "MessagesListPage.useEffect.fetchLastMessages": (msg)=>{
                            const otherId = msg.sender_id === user.id ? msg.receiver_id : msg.sender_id;
                            map[otherId] = msg;
                        }
                    }["MessagesListPage.useEffect.fetchLastMessages"]);
                    setLastMessages(map);
                }
            }["MessagesListPage.useEffect.fetchLastMessages"];
            if (user) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "MessagesListPage.useEffect": ()=>{
            ...
            socket.on("user_online", {
                "MessagesListPage.useEffect": (ids)=>setOnlineUsers(ids)
            }["MessagesListPage.useEffect"]);
            return ({
                "MessagesListPage.useEffect": ()=>{
    ...
    const filteredUsers = users.filter((u)=>u.id !== (user === null || user === void 0 ? void 0 : user.id)).filter((u)=>u.username.toLowerCase().includes(search.toLowerCase()));
                    ...
                    children: filteredUsers.map((u)=>{
                        ...
                        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
                            ...
                            children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                    className: "absolute bottom-0 right-0 w-3 h-3 rounded-full border-2 border-black ".concat(isOnline ? "bg-green-500" : "bg-gray-500")
                                                }, void 0, false, {
                                                    fileName: "[project]/src/app/messages/page.jsx",
                                                    lineNumber: 92,
                                                    columnNumber: 21
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            children: [
                                                ...
                                                lastMsg && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                    className: "text-gray-400 text-sm truncate max-w-[200px]",
                                                    children: [
                                ...
                                lastMsg && lastMsg.sender_id === u.id && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
...
_s(MessagesListPage, "eY4I1pRNUA2dOxeZQWg3DJr2geI=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$contexts$2f$AuthContext$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"],
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$contexts$2f$SocketContext$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSocket"],
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"]
...
//# sourceMappingURL=src_d46fc736._.js.map