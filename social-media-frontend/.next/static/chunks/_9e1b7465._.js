            ...
            const fetchUserProfile = {
                "ProfilePage.useEffect.fetchUserProfile": async ()=>{
                    try {
                        ...
                        if (!isOwnProfile) {
                            const followRes = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get("/users/".concat(res.data.user.id, "/followers"));
                            setIsFollowing(followRes.data.some({
                                "ProfilePage.useEffect.fetchUserProfile": (f)=>f.id === (currentUser === null || currentUser === void 0 ? void 0 : currentUser.id)
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            !isOwnProfile && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                ...
                                className: "mt-1 px-4 py-1 rounded text-white ".concat(isFollowing ? "bg-gray-500" : "bg-blue-500"),
...
_s(ProfilePage, "L/u+Aov51LySWIaqTxGf7FU/qtg=", false, function() {
    return [
...
//# sourceMappingURL=_9e1b7465._.js.map