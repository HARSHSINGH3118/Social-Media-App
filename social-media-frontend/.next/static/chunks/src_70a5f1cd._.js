...
const PostCard = (param)=>{
    ...
    const toggleLike = async ()=>{
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post("/posts/".concat(id, "/like"));
...
"[project]/src/app/explore/tag/[tag]/page.jsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const TagExplorePage = ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "TagExplorePage.useEffect": ()=>{
            if (!tag) return;
            const fetchPosts = {
                "TagExplorePage.useEffect.fetchPosts": async ()=>{
                    try {
                        const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get("/api/tags/".concat(tag, "/posts"));
            ...
            }["TagExplorePage.useEffect.fetchPosts"];
            fetchPosts();
        }
    }["TagExplorePage.useEffect"], [
        tag
    ...
    if (!posts || posts.length === 0) return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "text-center p-6",
        children: [
            "No posts found for ",
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
...
_s(TagExplorePage, "j7AMy5eItIrCaTBg0HfUGoIsSS4=", false, function() {
    return [
...
var _c;
__turbopack_context__.k.register(_c, "TagExplorePage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=src_70a5f1cd._.js.map