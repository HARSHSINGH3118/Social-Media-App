...
function RegisterPage() {
    ...
    const handleRegister = async (e)=>{
        e.preventDefault();
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post("/users/register", form);
            router.push("/login");
        } catch (err) {
...
//# sourceMappingURL=src_app_register_page_jsx_1e146504._.js.map