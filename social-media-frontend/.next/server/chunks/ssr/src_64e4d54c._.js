...
"[project]/src/app/profile/[username]/page.jsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function ProfilePage() {
    ...
    const { id: rawId } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useParams"])(); // now “id” instead of “username”
    ...
    // 1️⃣ Parse the ID param; if invalid, redirect to your own ID
    ...
    // 2️⃣ Are we viewing our own profile?
    const isOwnProfile = profileId === currentUser?.id;
    // 3️⃣ Fetch profile (own or public)
    const fetchUserProfile = async ()=>{
        try {
            // Use `/users/profile` for own, `/users/profile/:id` for others
            ...
            // Both endpoints now return { user, posts }
            ...
            // If someone else’s page, get follow state
            if (!isOwnProfile) {
                const fr = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get(`/users/${userData.id}/followers`);
            ...
            // If invalid ID, bounce home
            if (!isOwnProfile) router.replace(`/profile/${currentUser.id}`);
        }
    };
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
    ...
    const handleAvatarChange = async (e)=>{
        ...
        try {
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].put("/users/profile", formData);
    ...
    if (!user) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            fileName: "[project]/src/app/profile/[username]/page.jsx",
            lineNumber: 125,
            columnNumber: 7
        }, this);
    }
...
//# sourceMappingURL=src_64e4d54c._.js.map