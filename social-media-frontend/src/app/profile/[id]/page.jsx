...
import Sidebar from "@/components/Sidebar"; // ⬅️ Sidebar import
...
export default function ProfilePage() {
  ...
  return (
    <div className="min-h-screen flex bg-gray-950">
      {/* ✅ Fixed sidebar */}
      <div className="fixed top-0 left-0 h-screen w-64 bg-gray-900 border-r border-gray-800 z-50">
        <Sidebar />
      </div>

      {/* ✅ Scrollable content area with margin-left */}
      <div className="ml-64 flex-1 overflow-y-auto p-6 max-w-4xl text-white">
        {/* Avatar + Edit */}
